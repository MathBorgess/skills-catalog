...
// license) from Hugging Face, for skills-catalog#52's System One experiment
// (docs/system-one/README.md). Never run implicitly by `npm run check` or any
...
async function main() {
  ...
  const { loadCheckpoint } = await import("../skills/handoff/scripts/s1.mjs");
