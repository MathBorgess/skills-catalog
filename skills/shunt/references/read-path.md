...
- **Model selection**: Select the environment's `fast_cheap_own` model per [`prompts/model-routing.md`](../../../prompts/model-routing.md) (e.g. Flash, Haiku, Composer). Never spawn a frontier model for ingestion or summaries.
